...
- Publication state: commits through `2901fbd` are pushed to `origin/feat/pwa-interaction-fluidity` and draft PR [#5](https://github.com/HYJ1817/AI-reader/pull/5) targets `main`. The PR is not merged; production deployment is recorded above. Keep the worktree available for PR feedback.
