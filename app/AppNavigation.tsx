...
export default function AppNavigation({
  ...
  const dockTransition = reduceMotion
    ...
    : {
        type: "tween" as const,
        duration: MOTION_DURATION.pushEnter,
  ...
  }, [focusSearchInput, navigationRevision, reduceMotion, searchOpen]);
  ...
  return (
    <>
      {showBottomTabs && (
        ...
        >
          <m.div
            className={styles.navigationPrimarySlot}
            layoutId="navigation-primary-slot"
            layout
            transition={dockTransition}
          >
              ...
              {searchOpen ? (
                ...
                >
                  <m.span
                    ...
                    initial={false}
                    animate={{
                      x: `${getNavigationTabIndex(activeTab) * 100}%`,
                    }}
                    transition={
          ...
          <m.div
            className={styles.navigationSearchSlot}
            layoutId="navigation-search-slot"
            layout
            transition={dockTransition}
            onLayoutAnimationComplete={focusSearchInput}
          >
            <AnimatePresence initial={false} mode="popLayout">
              {searchOpen ? (
                <m.label
                  key="input"
                  className={styles.navigationSearchField}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  transition={{
...
function SearchIcon() {
  return (
    <svg
      className={styles.navigationSearchIcon}
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
    ...
    >
      ...
      <path d="m15.3 15.3 4.5 4.5" strokeLinecap="round" />
    </svg>
  );
}
...
function ChevronLeftIcon() {
  return (
    <svg
      className={styles.navigationBackIcon}
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
